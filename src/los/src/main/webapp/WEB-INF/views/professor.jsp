	...
	<md-tabs class="md-primary">
      <md-tab id="tab1" >
        ...
        <md-tab-template>
		 ...
		 <span style="font-size:26px;">Select Lecture:</span>
		 <md-autocomplete
      ...
      <md-tab id="tab2" ng-disabled="hasLecture">
        <md-tab-label>Quiz</md-tab-label>
        <md-tab-template>
          View for Item #2 <br/>
          data.selectedIndex = 1;
        </md-tab-template>
      </md-tab>
      <md-tab id="tab3" ng-disabled="hasLecture">
	...
	<md-content style="height: 600px;">
	    <section>
	      <md-list layout-padding>
	        <md-list-item class="md-3-line" ng-repeat="message in feedback">
	        	<div layout="row" class="md-whiteframe-z2 ellipsis" style="margin:16px;">
				  <div>
				  	<img ng-src="<c:url value="/resources/img/feedback.jpeg" />" class="md-avatar face" alt="{{message.who}}">
				  </div>
				  <div>
	  		        <div class="md-list-item-text" style="margin-left:16px">
	  		          <div layout="row">  		          
				         <div><img ng-src="<c:url value="/resources/img/star.png" />" style="width:12px; height:12px"></div>
				         <div><img ng-src="<c:url value="/resources/img/star.png" />" style="width:12px; height:12px"></div>
				         <div><img ng-src="<c:url value="/resources/img/star.png" />" style="width:12px; height:12px"></div>
				         <div><img ng-src="<c:url value="/resources/img/star.png" />" style="width:12px; height:12px"></div>
				         <div><img ng-src="<c:url value="/resources/img/star.png" />" style="width:12px; height:12px"></div>
      ...
      <md-tab id="tab4" ng-disabled="hasLecture">
